...
def get_player_info():
    ...
    try:
        ...
        # Log the response to check what you get back
        print(f"Response: {response.text}")  # This will print the raw response for debugging
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port=10000, debug=True)  # debug mode to see errors in Flask log
